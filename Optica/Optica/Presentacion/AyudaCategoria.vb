Public Class AyudaCategoria
    ...
    Private Sub AyudaCategoria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dgvCliente_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvCliente.CellDoubleClick
        If TextBox1.Text = "1" Then
            Productos.txtCodCategoria.Text = dgvCliente.SelectedCells.Item(1).Value
            Productos.txtCategoria.Text = dgvCliente.SelectedCells.Item(2).Value
            Me.Close()
