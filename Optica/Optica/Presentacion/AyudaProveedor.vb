Public Class AyudaProveedor
    Private dt As New DataTable
    Private Sub AyudaProveedor_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub dgvCliente_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvCliente.CellDoubleClick
        If TextBox1.Text = "1" Then
            Compra.txtCodSocio.Text = dgvCliente.SelectedCells.Item(1).Value
            Compra.txtSocio.Text = dgvCliente.SelectedCells.Item(2).Value
            Me.Close()
